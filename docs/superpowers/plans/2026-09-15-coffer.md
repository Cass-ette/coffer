...
final class LockCoordinator {
    ...
    func startEventObservers() {
        ...
        workspaceObservers = [
            ...
            center.addObserver(forName: NSWorkspace.screensDidLockNotification,
                               object: nil, queue: nil, using: immediate),
            center.addObserver(forName: NSWorkspace.sessionDidResignActiveNotification,
                               object: nil, queue: nil, using: immediate),
        ]
        // 屏保启动是分布式通知；个别版本若不触发，screensDidLock（系统默认屏保退出需密码）兜底
    ...
    func stopEventObservers() {
        ...
        workspaceObservers = []
        let distributed = NSDistributedNotificationCenter.default()
...
struct ChangeMasterPasswordSheet: View {
    ...
    private func change() {
        ...
        do {
            ...
            error = "更改失败：\(error.localizedDescription)"
        }
    }
}
```
